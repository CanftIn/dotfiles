...
(defun CanftIn/rename-file-and-buffer ()
...
(defun CanftIn/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun CanftIn/dired-do-command (command)
...
(defun CanftIn/dired-up-directory()
  "goto up directory and resue buffer"
  (interactive)
  (find-alternate-file ".."))

(defun CanftIn/insert-space-after-point ()
  (interactive)
